 ...
 */
public class MinerInterface extends MenuFactory{


    public MinerInterface(Player player, Minion minion){
...
//                                "&8• &7Minion Tag - &c" + (minion.getMinionTag() == null || minion.getMinionTag().getTag() == null ? "None" : minion.getMinionTag().getTag())
        ...
        addItem(new MenuItem(11, new ItemFactory(Material.EXP_BOTTLE)
            ...
            public void click(Player player, ClickType clickType) {
                ...
                if (clickType.isRightClick()) {
                    ...
                    minion.setHunger(miner.getHunger() + 2);
        ...
        addItem(new MenuItem(13, new ItemFactory(Material.GRASS)
                .setDisplayName("&a&lBlocks mined")
                .setLore(
                        "&8• &7This minion has mined &c" + miner.getBlocksMined() + " &7blocks!"
                )
                .build()));
